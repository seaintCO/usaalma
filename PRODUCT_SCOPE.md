...
ALMA is not a bank, payroll processor, tax filing service, CPA, law firm,
trading product, fitness product, construction-takeoff product, or creative
generation suite. Website/app building, presentations, image/video creation,
trading, fitness, and takeoff routes remain archived behind
`ALMA_LEGACY_MODULES_ENABLED` for migration safety and are disabled by default.
