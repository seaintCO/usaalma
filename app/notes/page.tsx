...
const text = {
  ...
  es: {
    ...
    new: "Nueva nota",
    search: "Buscar notas",
    empty: "AÃºn no hay notas.",
    saving: "Guardandoâ€¦",
    saved: "Guardado",
    error: "No se pudo guardar",
    delete: "Eliminar",
    body: "Escribe tu notaâ€¦",
  },
};
...
export default function NotesPage() {
  ...
  useEffect(() => {
    const l = localStorage.getItem("alma_language");
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-10">
        ...
        <section className="mt-8 rounded-[2rem] border border-[#E5E7EB] bg-white p-5 md:p-8">
          ...
          <div className="mt-7 grid min-h-[520px] gap-5 md:grid-cols-[280px_1fr]">
            <aside>
            ...
            <div className="rounded-2xl bg-[#F7F7F8] p-4">
              {note ? (
                ...
                <div className="grid h-full place-items-center text-sm text-[#6B7280]">
                  {t.empty}
                </div>
              )}
            </div>
