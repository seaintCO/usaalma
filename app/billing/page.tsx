...
const copy = {
  en: {
    ...
    essentialModules:
      "Customers, Inbox, Tasks, Calendar, Estimates, Invoices, Payments, Expenses, Receipts, Reports, Payroll preparation, Tax preparation, Documents, and rule-based automations",
    autonomousModules:
      "Everything in ALMA Office plus the metered ALMA business assistant, drafting, summaries, extraction, workflow generation, voice where configured, and approval-controlled actions",
    free: "Free",
    starter: "ALMA Office",
    pro: "ALMA AI",
    business: "ALMA AI",
  ...
  es: {
    ...
    essentialModules:
      "Clientes, Bandeja, Tareas, Calendario, Estimados, Facturas, Pagos, Gastos, Recibos, Reportes, Preparación de nómina, Preparación de impuestos, Documentos y automatizaciones por reglas",
    autonomousModules:
      "Todo en ALMA Office más el asistente empresarial medido, redacción, resúmenes, extracción, generación de flujos, voz donde esté configurada y acciones con aprobación",
    free: "Gratis",
    starter: "ALMA Office",
    pro: "ALMA AI",
    business: "ALMA AI",
